...
import com.sun.prism.shader.FillPgram_Color_AlphaTest_Loader;
...
public class MainTest1 {
    ...
    public static void main(String[] args) {
        ...
        GroupManagement groupM = new GroupManagement(new StrategyGrade(), students);
        System.out.println(groupM.createGrupo(5));
        groupM.setStrategy(new StrategyRandom());
        System.out.println(groupM.createGrupo(5));
