...
import groupmanager.sol1.GroupManagement;
...
public class MainTest {
    ...
    public static void main(String[] args) {
        ...
        GroupManagement groupM= new GroupManagement(students);
        System.out.println(groupM.createGrupo(GroupManagement.TYPE_GROUP.RANDOM, 5));
